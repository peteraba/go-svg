	...
	tests := []struct {
		...
		},
		{
			...
			[]string{
				...
				`<line x1="0" y1="30" x2="170" y2="30" stroke-width="2" stroke="#ff0000"></line>`,
				...
				`<text x="30" y="40" text-anchor="middle" stroke="#ff0000"><tspan x="0" y="0">foo</tspan></text>`,
				`<text x="30" y="40" text-anchor="start" stroke="#000080"><tspan x="0" y="0">bar</tspan></text>`,
				`</svg>`,
			},
			false,
		},
